...
CUSTOM_HAL_IMGSENSOR = imx214_mipi_raw ov4688_mipi_raw
CUSTOM_HAL_LENS = lc898122af dummy_lens
...
CUSTOM_HAL_SUB_IMGSENSOR = ov4688_mipi_raw
...
CUSTOM_KERNEL_DCT = htc_a51cml_dtul
CUSTOM_KERNEL_EEPROM = dummy_eeprom
CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
CUSTOM_KERNEL_GYROSCOPE =
CUSTOM_KERNEL_HEADSET = accdet
CUSTOM_KERNEL_IMGSENSOR = imx214_mipi_raw ov4688_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = lc898122af dummy_lens
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov4688_mipi_raw
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L1.MP3.TC7SP.p24.1
MTK_BWC_SUPPORT = yes
...
MTK_DX_HDCP_SUPPORT = yes
MTK_EAP_SIM_AKA = yes
MTK_EMMC_DISCARD = no
MTK_EMMC_SUPPORT = yes
MTK_EMMC_SUPPORT_OTP = no
MTK_DIFFER_PLATFROM_PARTITION_SUPPORT=yes
ifeq ($(PRIVATE_RCMS_SKU), HTCCN CHS 2)
MTK_SKU_PARTITION_SUPPORT= _china
else
MTK_SKU_PARTITION_SUPPORT= _others
endif
...
-include device/htc/$(TARGET_PRODUCT)/$(MTK_TARGET_PROJECT)/ProjectConfig.mk

MTK_TC7_FEATURE = yes
MTK_TC7_FEATURE_CRITICAL_SW_CAMERA = yes
MTK_OPERAMAX_SUPPORT = no

ifeq ($(PRIVATE_RCMS_SKU), HTCCN CHS CMCC)
BOOT_LOGO = cmcc_lte_fhd
CUSTOM_MODEM = mt6735_sp_lttg_dsds_m_mp7cmcc_prod mt6735_sp_lwg_dsds_m_mp7cmcc_prod
...
else ifeq ($(PRIVATE_RCMS_SKU), HTCCN CHS CMCC LAB)
BOOT_LOGO = cmcc_lte_fhd
CUSTOM_MODEM = mt6735_sp_lttg_dsds_m_mp7cmcc_prod mt6735_sp_lwg_dsds_m_mp7cmcc_prod
DEFAULT_INPUT_METHOD = com.iflytek.inputmethod.FlyIME
MTK_AAL_SUPPORT = no
...
MTK_DISABLE_CAPABILITY_SWITCH = no
OPTR_SPEC_SEG_DEF = OP01_SPEC0200_SEGC
else ifeq ($(PRIVATE_RCMS_SKU), HTCCN CHS CU)
BOOT_LOGO = cu_lte_fhd
CUSTOM_MODEM = mt6735_sp_lwg_dsds_prod mt6735_sp_lttg_dsds_prod
...
#HTC_AUD_START added by HTC AUDIO
NXP_SMARTPA_SUPPORT = htc
MTK_HDMI_MULTI_CHANNEL_SUPPORT = yes
HTC_NXP_RECEIVER_SUPPORT = yes
HTC_RT550x_SUPPORT = no
HTC_32BIT_EFFECT = yes
INCALL_RECORDING_ENABLED = yes

#Disable all htc feature for mfg ROM first
ifeq (true, $(MFG_ROM))
ENABLE_GLOBAL_SRS_EFFECT = no
ENABLE_SRS_EFFECT = no
ENABLE_SW_ALT = no
ENABLE_AOLC = no
NO_SOUND_DETECT = no
ENABLE_AUDIO_BALANCE = no
ENABLE_STEREO2MONO = no
ENABLE_HTC_SUBWOOFER = no
ENABLE_ACOUSTIC_SHOCK3 = no
# temporarily open to make MFG build pass.
ENABLE_MIRRORLINK_RECORD = yes
else
ENABLE_GLOBAL_SRS_EFFECT = no
ENABLE_SRS_EFFECT = no
ENABLE_SW_ALT = no
ENABLE_AOLC = no
NO_SOUND_DETECT = yes
ENABLE_AUDIO_BALANCE = yes
ENABLE_STEREO2MONO = yes
ENABLE_HTC_SUBWOOFER = yes
ENABLE_ACOUSTIC_SHOCK3 = yes
ENABLE_MIRRORLINK_RECORD = yes
endif
ENABLE_ACOUSTIC_SHOCK2 = no
SUBWOOFER_BUF_MAX = SUBWOOFER_BUF_MAX=20
SUBWOOFER_BUF_LEVEL = SUBWOOFER_BUF_LEVEL=3
FIXED_CALIBRATION = yes
FIXED_OHM_R = FIXED_OHM_R=7.49
FIXED_OHM_L = FIXED_OHM_L=6.9
#HTC_AUD_END

#Add WSD Configuration
include device/htc/$(TARGET_PRODUCT)/wsd_config.mk
#End WSD Configuration
================ END of FILE ===============
